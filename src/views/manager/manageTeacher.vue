<template>
    <div>
        <div style="display: flex;">
            <el-button type="primary" @click="addStudent" style="margin-right: 20px;">添加单个教师</el-button>
            <el-upload
                ref="upload"
                action="#"
                :limit="1"
            ...
            >
                <el-button type="primary" @click="addStudents">添加多个教师</el-button>
            </el-upload>
        </div>
        <!-- <el-button type="primary" @click="addStudents">添加多个教师</el-button> -->
        <el-table
        ...
        <el-dialog
            ...
            <div class="confirm-list">
                <div class="confirm-item-same" v-if="sameItems.length > 0">
                    <div style="margin-bottom: 20px;">以下教师工号已存在：</div>
                ...
                <div class="confirm-item-diff" v-if="diffItems.length > 0">
                    <div style="margin-bottom: 20px;font-size: 16px;font-weight: bold;">以下为新增教师：</div>
                    <div style="width: 100%; display: flex;flex-wrap: wrap">
                        <el-tag 
                            ...
                            @close="deleteTag(item)">{{ item['工号'] }} - {{ item['姓名'] }}</el-tag>
                    </div>
                </div>
            </div>
            <span slot="footer" class="dialog-footer">
